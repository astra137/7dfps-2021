...
uniform bool enable = false; // on and off switsch to diesable/enable the outline
// outline costumization
uniform float outline_thickness = 0.05; // how thick is the outline?
uniform vec4 color : hint_color = vec4(1.0, 1.0, 1.0, 1.0); // which color does the outline have?
